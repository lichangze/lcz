...
public class HomeController extends ActionBaseController<PageBaseParameter> {
    ...
    private IEnergyConsumptionService EnergyConsumptionservice;
		//青岛兑现
		@RequestMapping(value = "/zd_mb_dayadjust_qd", method = { RequestMethod.POST, RequestMethod.GET })
		public ModelAndView zd_mb_dayadjust_qd(HttpServletRequest request, HttpServletResponse response) {
			ModelAndView mav = new ModelAndView("zd_mb_dayadjust_qd");
			return mav;
		}
		@RequestMapping(value = "/getAdjustDataqd", method = { RequestMethod.POST, RequestMethod.GET })
		public void getAdjustDataqd(HttpServletRequest request, HttpServletResponse response) throws IOException{
		    ...
		    writeJSON(response, sdf.format(list.get(0).getRecordDate()));
		}
		@RequestMapping(value = "/zd_mb_monadjust_qd", method = { RequestMethod.POST, RequestMethod.GET })
		public ModelAndView zd_mb_monadjust_qd(HttpServletRequest request, HttpServletResponse response)
				throws SQLException {
			String line = request.getParameter("line");
			line = getURLDecoderString(line);
			ModelAndView mav = new ModelAndView("zd_mb_monadjust_qd");
			Example example = new Example(VehicleServiceUsageEntity.class);
			example.setOrderByClause("RecordDate desc");
				List<VehicleServiceUsageEntity> list = vehicleServiceUsageservice.selectByExample(example);
			mav.addObject("line", line);
			mav.addObject("date", sdf.format(list.get(0).getRecordDate()));
			return mav;
		}
		//青岛客流
		@RequestMapping(value = "/zd_mb_daypassenger_qd", method = { RequestMethod.POST, RequestMethod.GET })
		public ModelAndView zd_mb_daypassenger_qd(HttpServletRequest request, HttpServletResponse response) {
			ModelAndView mav = new ModelAndView("zd_mb_daypassenger_qd");
			return mav;
		}
		@RequestMapping(value = "/getPassengerDataqd", method = { RequestMethod.POST, RequestMethod.GET })
		public void getPassengerDataqd(HttpServletRequest request, HttpServletResponse response) throws IOException{
		...
		@RequestMapping(value = "/zd_mb_monpassenger_qd", method = { RequestMethod.POST, RequestMethod.GET })
		public ModelAndView zd_mb_monpassenger_qd(HttpServletRequest request, HttpServletResponse response)
				throws SQLException {
			String line = request.getParameter("line");
			line = getURLDecoderString(line);
			ModelAndView mav = new ModelAndView("zd_mb_monpassenger_qd");
			Example example = new Example(PassengerNumberEntity.class);
			example.setOrderByClause("RecordDate desc");
				List<PassengerNumberEntity> list = passEngerNumberService.selectByExample(example);
			    mav.addObject("line", line);
		...
		//青岛能耗
		@RequestMapping(value = "/zd_mb_dayener_qd", method = { RequestMethod.POST, RequestMethod.GET })
		public ModelAndView zd_mb_dayener_qd(HttpServletRequest request, HttpServletResponse response) {
			ModelAndView mav = new ModelAndView("zd_mb_dayener_qd");
			return mav;
		}
		@RequestMapping(value = "/getEnerDataqd", method = { RequestMethod.POST, RequestMethod.GET })
		public void getEnergyDataqd(HttpServletRequest request, HttpServletResponse response) throws IOException{
		...
		@RequestMapping(value = "/zd_mb_monener_qd", method = { RequestMethod.POST, RequestMethod.GET })
		public ModelAndView zd_mb_monener_qd(HttpServletRequest request, HttpServletResponse response)
				throws SQLException {
			String line = request.getParameter("line");
			line = getURLDecoderString(line);
			ModelAndView mav = new ModelAndView("zd_mb_monener_qd");
			Example example = new Example(EnergyConsumptionEntity.class);
			example.setOrderByClause("RecordDate desc");
				List<EnergyConsumptionEntity> list = EnergyConsumptionservice.selectByExample(example);
			mav.addObject("line", line);
