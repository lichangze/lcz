...
<div id="modal-table" class="modal fade" data-backdrop="static">
    <div class="modal-dialog" style="display: inline-block; width: auto">
        <div class="modal-content bmzy-modal-content" style="left:10%;  margin-top: 2%">
			...
			.ace_ajax(
					...
					function() {
						...
						jQuery(function($) {
							...
							var hiddenCols = $
									.ajax({
										url : "${contextPath}/sys/sysaccessm/getColHidden",
										async : false
									});
							...
							jQuery(grid_selector)
									.jqGrid(
											{
												subGrid : false,
												url : "${contextPath}/sys/sysflow/getFlowList",
												datatype : "json",
												height : 450,
												colNames : [ '', '流程名称', '流程编码',
														'流程id','流程参数','流程参数值','专业','urls', '有效码' ],
												colModel : [
														{
															name : '',
															index : '',
														...
														},
														{
															...
															width : 100,
															editable : true,
															hidden : (hiddenColsJSON.flowName == 'true'),
															editoptions : {
																size : "20",
																maxlength : "20"
															},
														...
														},
														{
															...
															width : 100,
															editable : true,
															hidden : (hiddenColsJSON.flowNo == 'true'),
															editoptions : {
																size : "20",
																maxlength : "20"
															},
														...
														},
														{
															...
															width : 80,
															editable : true,
															hidden : (hiddenColsJSON.flow_id == 'true'),
															editoptions : {
																size : "20",
																maxlength : "20"
															},
														...
														},
														{
															...
															width : 80,
															editable : true,
															hidden : (hiddenColsJSON.field_ids == 'true'),
															editoptions : {
																size : "20",
																maxlength : "50"
															},
														...
														},
														{
															...
															width : 80,
															editable : true,
															hidden : (hiddenColsJSON.field_values == 'true'),
															editoptions : {
																size : "20",
																maxlength : "50"
															},
									        				...
									        				editable : true,
									        				edittype : "select",
									        				hidden:(hiddenColsJSON.workGroup=='true'),
									        				editoptions : {dataUrl : "${contextPath}/sys/sysorgstru/getSysOrgStruSelectList1", title : "专业"},
									        				search : false
									        			},
														{
															name : 'urls',
															...
															width : 80,
															editable : true,
															hidden : (hiddenColsJSON.urls == 'true'),
															editoptions : {
																size : "20",
																maxlength : "200"
															},
												...
												editurl : "${contextPath}/sys/sysflow/doFlowList"
											});
									...
									.jqGrid(
											...
											pager_selector,
											{
												...
												onClickButton : function() {
													...
													var form = "<form name='csvexportform' action='${contextPath}/sys/position/doOperate?oper=excel' method='post'>";
													form = form
