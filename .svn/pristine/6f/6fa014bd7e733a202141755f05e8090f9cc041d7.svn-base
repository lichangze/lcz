...
<body style="background-color: #fff">
	...
	function addCellAttr(rowId, val, rawObject, cm, rdata){
		     return '天安门东'.indexOf(val) ? "" : "style='color:red'"
 ...
 function showMenu(event) {
  ...
  function init_zTree() {
	  ...
	  function onClick(e, treeId, treeNode) {
	    ...
	    $("#eqmArchitectureEntity").val(treeNode.name);
	    $("#eqmArchitectureID").val(treeNode.id);
	    hideMenu();
	  }

		try {
			$("#eqmTypeDefined8").datepicker({
				language : 'zh-CN',
				format : 'yyyy-mm-dd'
			});

			$("#runtimeBegin").datetimepicker({
				language : 'zh-CN',
				weekStart : 1,
				todayBtn : 1,
				autoclose : 1,
	...
	function initModelView(){
							...
							jQuery(eqm_fault_table_selector)
									.jqGrid(
											{
												subGrid : false,
												url : "${contextPath}/sys/eamPosition/logsDate",
												datatype : "json",
												postData : {
													typeid : function(params,postdata) {
												...
												height : '300',
												colNames : [ '版本', '修改人','修改时间','操作类型','合成码','车站编码',"父位置编码",'车站名称','线路编码','经度','纬度','主责单位','所属单位','备注'],
												colModel : [
														{
															name : 'rev',
															index : 'rev',
														...
														},
														{
															...
															name : 'eamPositionEntity.position_no',
															index : 'position_no',
															label : '合成码',
															width : 100,
															editable : false,
														...
														{
															name : 'eamPositionEntity.position_code',
															index : 'position_code',
															label : '车站编码',
															width : 80,
															editable : true,
															...
															name : 'eamPositionEntity.f_position_no',
															index : 'f_position_no',
															label : '父位置编码',
															width : 80,
															editable : true, 
															...
															name : 'eamPositionEntity.position_name',
															index : 'position_name',
															label : '车站名称',
															width : 80,
															editable : true,
															...
															name : 'eamPositionEntity.line_code',
															index : 'line_code',
															label : '线路编码',
															width : 80,
															editable : true,
															...
															name : 'eamPositionEntity.longitude',
															index : 'longitude',
															label : '经度',
															width : 80,
															//type:date,
															...
															name : 'eamPositionEntity.latitude',
															index : 'latitude',
															label : '纬度',
															width : 80,
															editable : true,
															...
															name : 'eamPositionEntity.dept_no',
															index : 'dept_no',
															label : '主责单位',
															width : 80,
															editable : true,
															...
															name : 'eamPositionEntity.belong_no',
															index : 'belong_no',
															label : '所在单位',
															width : 80,
															editable : true,
