...
<body>
        ...
        <div  class="table">
        	...
        	<font class="titlefont" >北京地铁运分公司展示平台</font>
         ...
         <!-- 显示主体 -->
        	<iframe id="myframe" src="http://finereport.bjdt.bmzymtr.com:30001/WebReport/report/bigoperate" width=100%; height=100%; frameborder=0;  scrolling="no"></iframe>
        </div>
