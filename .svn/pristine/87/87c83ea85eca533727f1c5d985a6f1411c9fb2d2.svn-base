...
<script type="text/javascript">
	...
	var url = encodeURI(encodeURI("http://finereport.bjdt.bmzymtr.com:30001/webreport/ReportServer?formlet=ZD_MB_JAVAmonpassenger.frm&line=${line}&date="+dateck));
	...
	function changeUrl(){
		...
		var urlValue = "http://finereport.bjdt.bmzymtr.com:30001/webreport/ReportServer?formlet=ZD_MB_JAVAmonpassenger.frm&date="+date+"&line="+line+"";// 这里一定要转两次码，不然解析出来的依然是乱码
