...
<head>
    ...
    <!-- The styles -->
    <link href="${contextPath}/static/css/bootstrap-cerulean.min.css" rel="stylesheet">
    <link href="${contextPath}/static/css/charisma-app.css" rel="stylesheet">
    <link href='${contextPath}/static/bower_components/fullcalendar/dist/fullcalendar.css' rel='stylesheet'>
    <link href='${contextPath}/static/bower_components/fullcalendar/dist/fullcalendar.print.css' rel='stylesheet' media='print'>
    <link href='${contextPath}/static/bower_components/chosen/chosen.min.css' rel='stylesheet'>
    <link href='${contextPath}/static/bower_components/colorbox/example3/colorbox.css' rel='stylesheet'>
    <link href='${contextPath}/static/bower_components/responsive-tables/responsive-tables.css' rel='stylesheet'>
    <link href='${contextPath}/static/bower_components/bootstrap-tour/build/css/bootstrap-tour.min.css' rel='stylesheet'>
    <link href='${contextPath}/static/css/jquery.noty.css' rel='stylesheet'>
    <link href='${contextPath}/static/css/noty_theme_default.css' rel='stylesheet'>
    <link href='${contextPath}/static/css/elfinder.min.css' rel='stylesheet'>
    <link href='${contextPath}/static/css/elfinder.theme.css' rel='stylesheet'>
    <link href='${contextPath}/static/css/jquery.iphone.toggle.css' rel='stylesheet'>
    <link href='${contextPath}/static/css/uploadify.css' rel='stylesheet'>
    <link href='${contextPath}/static/css/animate.min.css' rel='stylesheet'>

    <!-- jQuery -->
    <script src="${contextPath}/static/bower_components/jquery/jquery.min.js"></script>

    <!-- The HTML5 shim, for IE6-8 support of HTML5 elements -->
    <!--[if lt IE 9]>
    <script src="${contextPath}/static/http://html5shim.googlecode.com/svn/trunk/html5.js"></script>
    <![endif]-->

    <!-- The fav icon -->
    <link rel="shortcut icon" href="${contextPath}/static/img/favicon.ico">
...
<body>
    ...
    <div class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-inner">
            ...
            <a class="navbar-brand" href="index.html"> <img alt="Charisma Logo" src="${contextPath}/static/img/logo20.png" class="hidden-xs"/>
...
<!-- calender plugin -->
<script src='${contextPath}/static/bower_components/moment/min/moment.min.js'></script>
<script src='${contextPath}/static/bower_components/fullcalendar/dist/fullcalendar.min.js'></script>
<!-- data table plugin -->
<script src='${contextPath}/static/js/jquery.dataTables.min.js'></script>

<!-- select or dropdown enhancer -->
<script src="${contextPath}/static/bower_components/chosen/chosen.jquery.min.js"></script>
<!-- plugin for gallery image view -->
<script src="${contextPath}/static/bower_components/colorbox/jquery.colorbox-min.js"></script>
<!-- notification plugin -->
<script src="${contextPath}/static/js/jquery.noty.js"></script>
<!-- library for making tables responsive -->
<script src="${contextPath}/static/bower_components/responsive-tables/responsive-tables.js"></script>
<!-- tour plugin -->
<script src="${contextPath}/static/bower_components/bootstrap-tour/build/js/bootstrap-tour.min.js"></script>
<!-- star rating plugin -->
<script src="${contextPath}/static/js/jquery.raty.min.js"></script>
<!-- for iOS style toggle switch -->
<script src="${contextPath}/static/js/jquery.iphone.toggle.js"></script>
<!-- autogrowing textarea plugin -->
<script src="${contextPath}/static/js/jquery.autogrow-textarea.js"></script>
<!-- multiple file upload plugin -->
<script src="${contextPath}/static/js/jquery.uploadify-3.1.min.js"></script>
<!-- history.js for cross-browser state change on ajax -->
<script src="${contextPath}/static/js/jquery.history.js"></script>
<!-- application script for Charisma demo -->
<script src="${contextPath}/static/js/charisma.js"></script>
