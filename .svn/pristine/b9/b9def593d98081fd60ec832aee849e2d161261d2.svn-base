...
<html>
	...
	<body>
		<div data-role="page" id="pageone">
			...
			<div class="A" ><iframe src="http://localhost:8075/WebReport/ReportServer?reportlet=ZD_MB_CAR.cpt&date=2017-05-06" id="myiframe" scrolling="no" onload="changeFrameHeight()" frameborder="0"></iframe></div>
		</div>
<script type="text/javascript">
...
$.ajax({
	cache : true,
	type : "POST",
	url : "${contextPath}/report/getCarData",
	async : false,
	success : function(data) {
		 changeFrameHeight();  
		var url = encodeURI(encodeURI("http://finereport.bjdt.bmzymtr.com:30001/webreport/ReportServer?reportlet=车辆故障统计表.cpt&date="+data+""));
...
function changeUrl(){
	...
	var urlValue = "http://finereport.bjdt.bmzymtr.com:30001/webreport/ReportServer?reportlet=车辆故障统计表.cpt&date="+date+"";// 这里一定要转两次码，不然解析出来的依然是乱码
