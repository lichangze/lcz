...
<body>
    <div class="main">
        ...
        <div  class="quarter-div gis">
        	<iframe src="" width=100%; height=100%; scrolling="no"></iframe>
        </div>
        
        <div class="tablediv lefttable1">
       
            <iframe src="http://localhost:8075/WebReport/ReportServer?formlet=4_hr_quarter.frm" width=320px; height=80%; scrolling="no"; frameborder=0; style="margin:40px;">
        	</iframe>
        </div>
        <div class="tablediv lefttable2">
           <iframe src=""  width=320px; height=80%; scrolling="no"; frameborder=0; style="margin:40px;">
        	</iframe>
        </div>
        ...
        <div class="tabledivr righttable1">
        	<iframe src="http://localhost:8075/WebReport/ReportServer?formlet=4_hr_quarter_top.frm" width=440px; height=80%; scrolling="no"; frameborder=0; style="margin:40px;">
        	</iframe>
        </div>
