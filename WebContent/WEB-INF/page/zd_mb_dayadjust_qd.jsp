...
<html>
	...
	<body>
		<div data-role="page" id="pageone">
			...
			<div class="A" ><iframe src="http://report.bmzymtr.com:10080/webreport/ReportServer?formlet=zd_dayadjust.frm&date=2017-05-06" id="myiframe" scrolling="no" onload="changeFrameHeight()" frameborder="0"></iframe></div>
		</div>
<script type="text/javascript">
...
$.ajax({
	cache : true,
	type : "POST",
	url : "${contextPath}/report/getAdjustDataqd",
	async : false,
	success : function(data) {
		var url = encodeURI(encodeURI("http://report.bmzymtr.com:10080/webreport/ReportServer?formlet=zd_dayadjust.frm&date="+data+""));
...
function changeUrl(){
	...
	var urlValue = "http://report.bmzymtr.com:10080/webreport/ReportServer?formlet=zd_dayadjust.frm&date="+date+"";// 这里一定要转两次码，不然解析出来的依然是乱码
