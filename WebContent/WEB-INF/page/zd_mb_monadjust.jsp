...
<div data-role="page" id="pageone">
	...
	<div class="A">
		<iframe
			src="
http://finereport.bjdt.bmzymtr.com:30001/webreport/ReportServer?formlet=ZD_MB_JAVAmonadjust.frm&line=${line}&date=${date}"
...
<script type="text/javascript">
	...
	var codate = getCookie("adjdate");
	if(codate != null){
		 codate = getCookie("adjdate").substring(0,7);
	}else{
		var date = "${date}";
		codate=date.substring(0,7);
	}
	var url = encodeURI(encodeURI("http://finereport.bjdt.bmzymtr.com:30001/webreport/ReportServer?formlet=ZD_MB_JAVAmonadjust.frm&line=${line}&date="+codate));
	$('#myiframe').attr('src',url);
	function changeUrl(){
		var date = $("#txtBirthday").val();
		var line = $("#line").val();
		var urlValue = "http://finereport.bjdt.bmzymtr.com:30001/webreport/ReportServer?formlet=ZD_MB_JAVAmonadjust.frm&date="+date+"&line="+line+"";// 这里一定要转两次码，不然解析出来的依然是乱码
