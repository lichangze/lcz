...
<html>
	...
	<body>
		<div data-role="page" id="pageone">
			...
			<div class="A" ><iframe src="http://finereport.bjdt.bmzymtr.com:30001/webreport/ReportServer?formlet=ZD_MB_JAVA%5B65e5%5D%5B5ba2%5D%5B6d41%5D%5B5206%5D%5B6790%5D.frm&date=2017-05-06 " id="myiframe" scrolling="no" onload="changeFrameHeight()" frameborder="0"></iframe></div>
		</div>
	<script type="text/javascript">
	...
	$.ajax({
		cache : true,
		type : "POST",
		url : "${contextPath}/report/getPassengerData",
		async : false,
		success : function(data) {
			var url = encodeURI(encodeURI("http://finereport.bjdt.bmzymtr.com:30001/webreport/ReportServer?formlet=ZD_MB_JAVA日客流分析.frm&date="+data+""));
     ...
     function changeUrl(){
     	...
     	setCookie("dateck",date,"h12");
     	var urlValue = "http://finereport.bjdt.bmzymtr.com:30001/webreport/ReportServer?formlet=ZD_MB_JAVA%5B65e5%5D%5B5ba2%5D%5B6d41%5D%5B5206%5D%5B6790%5D.frm&date="+date+"";// 这里一定要转两次码，不然解析出来的依然是乱码
