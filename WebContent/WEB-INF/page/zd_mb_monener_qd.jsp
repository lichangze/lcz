...
<script type="text/javascript">
	...
	var url = encodeURI(encodeURI("http://report.bmzymtr.com:10080/webreport/ReportServer?formlet=zd_monener.frm&line=${line}&date="+dateck));
	...
	function changeUrl(){
		...
		var urlValue = "http://report.bmzymtr.com:10080/webreport/ReportServer?formlet=zd_monener.frm&date="+date+"&line="+line+"";// 这里一定要转两次码，不然解析出来的依然是乱码
