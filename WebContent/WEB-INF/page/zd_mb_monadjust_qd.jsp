...
<div data-role="page" id="pageone">
	...
	<div class="A">
		<iframe
			src="
http://report.bmzymtr.com:10080/webreport/ReportServer?formlet=zd_monadjust.frm&line=${line}&date=${date}"
...
<script type="text/javascript">
	...
	var url = encodeURI(encodeURI("http://report.bmzymtr.com:10080/webreport/ReportServer?formlet=zd_monadjust.frm&line=${line}&date="+codate));
	$('#myiframe').attr('src',url);
	function changeUrl(){
		var date = $("#txtBirthday").val();
		var line = $("#line").val();
		var urlValue = "http://report.bmzymtr.com:10080/webreport/ReportServer?formlet=zd_monadjust.frm&date="+date+"&line="+line+"";// 这里一定要转两次码，不然解析出来的依然是乱码
